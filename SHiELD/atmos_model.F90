...
!quantities going from land+ice to atmos
   ...
   real, dimension(:,:),   pointer :: un_ref         =>null() ! surface neutral zonal wind, added by Biao
   real, dimension(:,:),   pointer :: vn_ref         =>null() ! surface neutral meridional wind, added by Biao
